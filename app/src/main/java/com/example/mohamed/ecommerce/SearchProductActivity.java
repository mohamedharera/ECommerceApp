...
import com.example.mohamed.ecommerce.ViewHolder.ProductViewHolder;
...
public class SearchProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.RecyclerView_search_products);
        ...
        searchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                search = search_products.getText().toString();
                onStart();
            }
        });
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products>options = new FirebaseRecyclerOptions.Builder<Products>()
                .setQuery(reference.orderByChild("pname").startAt(search),Products.class)
                .build();
